...
public class PostDto {
	...
	public String toString() {
		return "PostDto [id=" + id + ", title=" + title + ", description=" + description + ", content=" + content
				+ ", comments=" + comments + ", categoryId=" + categoryId + ", getId()=" + getId() + ", getTitle()="
				+ getTitle() + ", getDescription()=" + getDescription() + ", getContent()=" + getContent()
				+ ", getComments()=" + getComments() + ", getCategoryId()=" + getCategoryId() + ", getClass()="
